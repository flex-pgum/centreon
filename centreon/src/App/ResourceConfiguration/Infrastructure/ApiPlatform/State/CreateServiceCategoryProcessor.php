...
final readonly class CreateServiceCategoryProcessor implements ProcessorInterface
{
    ...
    {
        if (! $this->security->isGranted(ServiceCategoryPermissionEnum::CanWrite->value)) {
            throw new AccessDeniedException('You are not allowed to create service categories');
        }
